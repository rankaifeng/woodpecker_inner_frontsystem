        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <Form.Item label="租期开始时间" {...formItemLayout}>
            {getFieldDecorator("beginlent", {
              initialValue: moment(data.beginlent,dateFormat),
              rules: [
                {
                  required: true,
                  message: "请输入租期开始时间"
          ...
          <Form.Item label="租期结束时间" {...formItemLayout}>
            {getFieldDecorator("endlent", {
              initialValue: moment(data.endlent,dateFormat),
              rules: [
                {
                  required: true,
                  message: "请输入租期结束时间"
          ...
          <Form.Item label="维护开始时间" {...formItemLayout}>
            {getFieldDecorator("beginmaintain", {
              initialValue: moment(data.beginmaintain,dateFormat),
              rules: [
                {
                  required: true,
                  message: "请输入维护开始时间"
          ...
          <Form.Item label="维护结束时间" {...formItemLayout}>
            {getFieldDecorator("endmaintain", {
              initialValue: moment(data.endmaintain,dateFormat),
              rules: [
                {
                  required: true,
                  message: "请输入维护结束时间"
          ...
          <Form.Item label="质保开始时间" {...formItemLayout}>
            {getFieldDecorator("begintime", {
              initialValue: moment(data.begintime,dateFormat),
              rules: [
                {
                  required: true,
                  message: "请输入质保开始时间"
          ...
          <Form.Item label="质保结束时间" {...formItemLayout}>
            {getFieldDecorator("endtime", {
              initialValue: moment(data.endtime,dateFormat),
              rules: [
                {
                  required: true,
                  message: "请输入质保结束时间"
