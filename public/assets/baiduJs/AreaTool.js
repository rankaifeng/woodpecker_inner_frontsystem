/**
 * @fileoverview  面积测量工具（由百度地图的鼠标绘制工具改写）。
 * 允许用户在地图上点击完成鼠标绘制的功能。
 * 使用者可以自定义所绘制结果的相关样式，例如线宽、颜色、测线段距离、面积等等。
 * 主入口类是<a href="symbols/BMapLib.AreaTool.html">AreaTool</a>，
 * 基于Baidu Map API 1.4。
 *
 * @author 成都水经注软件 
 * @version 1.4
...
(function() {
    ...
    /** 
     * @exports AreaTool as BMapLib.AreaTool 
     */
    var AreaTool =
        /**
         * AreaTool类的构造函数
         ...
         * var myDrawingManagerObject = new BMapLib.AreaTool(map, {isOpen: true, 
         ...
         *     });
         */
        BMapLib.AreaTool = function(map, opts) {
            if (!map) {
                return;
            }
    ...
    // 通过baidu.lang下的inherits方法，让AreaTool继承baidu.lang.Class
    baidu.lang.inherits(AreaTool, baidu.lang.Class, "AreaTool");
     ...
     */
    AreaTool.prototype.open = function() {
        // 判断绘制状态是否已经开启
     ...
     */
    AreaTool.prototype.close = function() {
     ...
     * 删除测量overlay
     */
    AreaTool.prototype.clearAllMeasure = function() {
        this._clearAllMeasure();
    }
     ...
     */
    AreaTool.prototype.setDrawingMode = function(drawingType) {
        //与当前模式不一样时候才进行重新绑定事件
     ...
     */
    AreaTool.prototype.getDrawingMode = function() {
     ...
     */
    AreaTool.prototype.enableCalculate = function() {
     ...
     */
    AreaTool.prototype.disableCalculate = function() {
     ...
     * myDrawingManagerObject.disableCalculate();
     */
    AreaTool.prototype.bindEventByDraingMode = function(drawingType) {
        this._bindEventByDraingMode(drawingType);
    }

    /**
     * 鼠标绘制完成后，派发总事件的接口
     * @name AreaTool#overlaycomplete
     * @event
    ...
    /**
     * 绘制线完成后，派发的事件接口
     * @name AreaTool#polylinecomplete
     * @event
    ...
    /**
     * 绘制矩形完成后，派发的事件接口
     * @name AreaTool#rectanglecomplete
     * @event
     * @param {Polygon} overlay 回调函数会返回相应的覆盖物，
     * <br />{"<b>overlay</b> : {Polygon} 
     */
     ...
     * @param {Object} 参数
     */
    AreaTool.prototype._initialize = function(map, opts) {
             ...
             * @type {DrawingType}
             */
            this._drawingType = opts.drawingMode || BMAP_DRAWING_POLYGON;
         ...
         */
        AreaTool.prototype._open = function() {
     ...
     * @param {DrawingType}
     */
    AreaTool.prototype._setDrawingMode = function(drawingType) {
     ...
     */
    AreaTool.prototype._close = function() {
     ...
     * 绑定鼠标画点的事件
     */
    AreaTool.prototype._bindMarker = function() {
     ...
     * 绑定鼠标画圆的事件
     */
    AreaTool.prototype._bindCircle = function() {
     ...
     * 删除测量overlay
     */
    AreaTool.prototype._clearAllMeasure = function() {
     ...
     */
    AreaTool.prototype._bindPolylineOrPolygon = function() {
        ...
        var startAction = function(e) {
            ...
            if (points.length == 1) {
                ...
                if (overlay instanceof BMap.Polygon && BMapLib.GeoUtils) {
                    var labelpoint = overlay.getBounds().getCenter();
                    var area = BMapLib.GeoUtils.getPolygonArea(overlay);
                    if (!area) {
                        return;
                    }
                    if (area > 1000) {
                        area = (area / 1000000).toString().fixed(2) + '平方公里';
                    } else {
                        area = area.toString().fixed(2) + '平方米';
                    }
                    if (overlay['label'] instanceof BMap.Label) {
                        overlay['label'].setPosition(labelpoint);
                        overlay['label'].setContent(area);
                    }
                }
            }
            if (!isBinded) {
     ...
     * 绑定鼠标画矩形的事件
     */
    AreaTool.prototype._bindRectangle = function() {
     ...
     * @param {point} 显示的位置
     */
    AreaTool.prototype._calculate = function(overlay, point) {
        var result = {
            data: 0, //计算出来的长度或面积
     ...
     */
    AreaTool.prototype._addGeoUtilsLibrary = function() {
        if (!BMapLib.GeoUtils) {
            var script = document.createElement('script');
            script.setAttribute("type", "text/javascript");
            script.setAttribute("src", 'assets/baiduJs/GeoUtils.js');
     ...
     */
    AreaTool.prototype._addLabel = function(point, content) {
     ...
     * @param {Point} 终点
     */
    AreaTool.prototype._getRectanglePoint = function(startPoint, endPoint) {
        return [
     ...
     * 派发事件
     */
    AreaTool.prototype._dispatchOverlayComplete = function(overlay, calculate) {
        var options = {
            'overlay': overlay,
